import { ServiceData, FaqItem } from './types';
...
export const SERVICES: ServiceData[] = [
  ...
  },
  {
    ...
    fullContent: [
      ...
      'É importante ressaltar que a depressão não é sinal de fraqueza ou falta de vontade. É uma condição de saúde que requer tratamento compassivo e profissional. A terapia oferece um ambiente onde a dor é validada e compreendida, reduzindo o isolamento e a culpa que frequentemente acompanham o quadro. Você não precisa carregar esse peso sozinho.',
      'Com o tempo e o acompanhamento adequado, é possível restaurar a esperança e o equilíbrio emocional. O tratamento visa não apenas a remissão dos sintomas, mas a construção de uma vida com mais significado, onde você possa se reconectar com seus desejos, sonhos e com as pessoas que ama.'
    ]
  },
  {
    id: 'ansiedade',
    ...
    fullContent: [
      ...
      'Além das técnicas de relaxamento, investigamos a fundo os padrões de pensamento que geram o medo e a insegurança. Entender a origem dessas preocupações excessivas é o primeiro passo para desarmá-las. O objetivo é transformar a ansiedade de um inimigo paralisante em um sinal de alerta gerenciável, que não impede você de viver suas experiências.',
      'Viver sem a constante sensação de alerta é possível. Através da psicoterapia, você aprenderá a estabelecer limites saudáveis, a lidar com a incerteza de forma mais leve e a confiar mais na sua capacidade de enfrentar desafios. O resultado é uma vida mais leve, produtiva e serena.'
    ]
  },
  {
    id: 'autoestima',
